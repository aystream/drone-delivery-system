package com.musala.services.drone.exception;
...
public class ExceptionApiHandler {
    ...
    @ExceptionHandler(DroneErrorException.class)
    public ResponseEntity<ErrorResponse> handleClientException(DroneErrorException e) {
